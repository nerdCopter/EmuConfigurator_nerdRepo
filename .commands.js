// Auto-generated: run via `yarn commands`
console.log(`
Available Commands:
  ...
  yarn commands         Show this command list
  yarn test             Run Karma test suite
  yarn lint             Run ESLint

Canonical commands: dev, make, make:debug, package, package:debug
`);
